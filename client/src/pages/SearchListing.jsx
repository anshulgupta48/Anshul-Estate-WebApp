...
const SearchListing = () => {
    ...
    const fetchListings = async () => {
        ...
        const res = await fetch(`/api/listing/search-listings?${searchQuery}`);
        ...
        <div className='flex flex-col md:flex-row'>
            ...
            <div className='flex-1'>
                ...
                <div className='p-7 flex flex-wrap gap-4'>
                    ...
                    {showMore && (<button onClick={handleShowMore} className='text-green-700 hover:underline p-7 text-center w-full' >
                        Show more
                    </button>
                    )}
                </div>
