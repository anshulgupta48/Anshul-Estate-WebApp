...
const UpdateListing = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.isSuccess === false) {
        ...
        toast.success('Listing Updated Successfully', { duration: 4000 });
  ...
  const handleRemoveImage = (imageIndex) => {
    setFormData({ ...formData, imageUrls: formData.imageUrls.filter((item, index) => imageIndex !== index) });
  };
    ...
    <main className='p-3 max-w-4xl mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
        <div className='flex flex-col gap-4 flex-1'>
          ...
          <textarea type='text' placeholder='Description' className='border p-3 rounded-lg resize-none' id='description' required onChange={handleChange} value={formData.description} />
